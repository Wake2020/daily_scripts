	...
	!(async () => {
		...
		for (let i = 0; i < cookiesArr.length; i++) {
			if (cookiesArr[i]) {
				...
				if(args.useful_account.indexOf($.UserName) == -1)
					continue;
				$.index = i + 1;
				$.isLogin = true;
				$.nickName = '';
