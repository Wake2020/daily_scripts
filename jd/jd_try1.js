...
# 京东试用3
30 20 * * * https://raw.githubusercontent.com/ZCY01/daily_scripts/main/jd/jd_try.js, tag=京东试用3, img-url=https://raw.githubusercontent.com/ZCY01/img/master/jdtryv1.png, enabled=true
 */
const $ = new Env('京东试用3')
...
const args = {
	...
	typeList: [],
	whiteList: ["显示屏","华为手环","打印机","联名","青岛啤酒","燕京啤酒","精酿","茅台王子酒","键盘","雅诗兰黛","兰蔻","雅培","爱他美","卓萃","飞鹤","美赞臣","贝因美",
		    "HFP","露得清","维多利亚的秘密","五粮液","国窖1573","蓝牙耳机","矿泉水","元気森林","九阳豆浆机","玉米油","羽毛球拍","大米","面粉","燕麦","乌苏##啤酒",
		    "泸州老窖","汾酒","沱牌","郎酒","雀巢","钟薛高","平板电视机","星巴克","施华洛世奇","香薰蜡烛","中粮","技嘉##主板","京东Plus会员","茅台生态","酒鬼","牛栏山",
		    "红星二锅头","牛奶##g","牛奶##ml","牛奶##L","洋河蓝色经典","金龙鱼","张裕##葡萄酒","拉菲##葡萄酒","三只松鼠##大礼包","叶帆##摇摇椅","电竞椅","全身镜",
		    "屏幕挂灯","运动鞋##男##41##黑","制冰机","冰淇淋机","唱吧K歌宝","科大讯飞##录音笔","无人机","移动硬盘","固态硬盘","SK-II","风扇","茅台##葡萄酒","红花郎",
		    ...
		    "元气森林","Molto Bella","气球套餐","龙井##茶","摄像头","原浆##啤酒","破壁机","保温杯","雨伞","中国代表团##口罩","冬枣","泡面##箱","零食##大礼包",
		    "airpods##保护套"],
