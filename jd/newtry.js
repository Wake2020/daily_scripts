...
function requireConfig(){
    return new Promise(resolve => {
        ...
        if($.isNode()){
            ...
            if(process.env.JD_TRY_MAXSUPPLYNUM) args_xh.maxSupplyNum = process.env.JD_TRY_MAXSUPPLYNUM * 1
                                    ...
                                    if(data.data.feedList[i].skuTitle !== undefined){
                                        ...
                                        for(let filters of args_xh.titleFilters){
                                            ...
                                            if(data.data.feedList[i].skuTitle.indexOf(filters) !== -1){
                                                $.isPush = false;
                                                console.log(`商品已过滤，含有关键词 ${filters}\n`)
                                                break;
                                            }
                                            $.isPush = true;
                                        }
