...
const args = {
	...
	typeList: [],
	whiteList: ["显示屏","剃须刀","飞科","英睿达","内存条","显卡","路由器","雅诗兰黛","监控器","摄像机","九阳","凉霸","每日坚果","三只松鼠","麦克风","格力","科大讯飞","良品铺子","松下","威力","松下","苏泊尔","海尔","方太","美的","国窖1573","电热水壶","耳机","高清摄像头","电池炉","不粘锅","电压力锅","电饭煲","电饭锅","五粮液","泸州老窖","咖啡机","西部数据","华为手环","小米手环","平板电脑","青岛啤酒","燕京啤酒","洗衣机","电风扇","苏泊尔","九阳","液晶智能电视","吸尘器","吹风机","破壁机","豆浆机","机械硬盘","高色域","机械硬盘","骁龙","固态硬盘","葡萄酒","空调","65英寸","全面屏","超清影像","超级快充","点读机","激光脱毛器","蓝牙耳机","荣耀50","机械键盘","静音电源","电脑椅","办公椅","靠背座椅","百雀羚","学习机","婴幼儿羊奶粉悦白800g","白酒","华为手环","打印机","洗车机","游戏鼠标","罗技","电视盒子","智能手表","监控摄像头","儿童电话手表","智能电动牙刷","兰蔻","方庄北京二锅头","体温监测仪","475ml","除湿机","空气净化器","松下","暖风机","洗碗机","洗地机","笔记本电脑","高性能轻薄本","玉兰油","OLAY","轻薄笔记本","烧水壶","咖啡机","蓝牙音箱"],
